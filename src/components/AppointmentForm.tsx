...
import { CalendarIcon, Search, User, PawPrint, Check, ChevronsUpDown, Clock } from "lucide-react"; // Adicionado Clock icon
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        <FormItem className="flex flex-col">
          <FormLabel>Data e Hora da Consulta</FormLabel>
          <Popover>
            <PopoverTrigger asChild>
              <Button
                ...
                disabled // Bloqueia o PopoverTrigger
              >
