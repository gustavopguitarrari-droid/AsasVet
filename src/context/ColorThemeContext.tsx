...
type ColorTheme = 'orange' | 'blue' | 'green' | 'vivid-green' | 'purple' | 'pink' | 'yellow' | 'red' | 'teal-blue'; // NOVO: Tipos de tema atualizados
...
export const ColorThemeProvider = ({ children }: { children: ReactNode }) => {
  ...
  // O tema de cor agora vem do perfil do usuário. Se não houver usuário ou tema, usa 'teal-blue'.
  const currentColorTheme: ColorTheme = (user?.colorTheme as ColorTheme) || 'teal-blue'; // NOVO: Padrão para 'teal-blue'
  ...
  useEffect(() => {
    ...
    root.classList.remove('theme-orange', 'theme-blue', 'theme-green', 'theme-vivid-green', 'theme-purple', 'theme-pink', 'theme-yellow', 'theme-red', 'theme-teal-blue'); // NOVO: Classes de tema atualizadas
