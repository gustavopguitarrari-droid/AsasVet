  ...
  if (error || medicalRecordError || clientsError || petsError || veterinariansError || productsError || animalDebitsError) {
    return (
      <div className="flex items-center justify-center h-full text-destructive">
        ...
        <Button onClick={() => navigate('/consultas')} className="ml-4 bg-primary hover:bg-primary/90 text-primary-foreground">
  ...
  return (
    <div className="space-y-6 w-full">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => navigate('/consultas')} className="bg-primary hover:bg-primary/90 text-primary-foreground">
          <ArrowLeft className="mr-2 h-4 w-4" /> Voltar para Consultas
        </Button>
      </div>
