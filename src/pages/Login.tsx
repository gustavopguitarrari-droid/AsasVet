...
const Login = () => {
  ...
  return (
    <div className={cn(
      ...
      <div className="w-full max-w-sm p-6 space-y-4 rounded-xl shadow-lg relative bg-white/80 backdrop-blur-sm border border-marrom-avela/20 z-10 max-h-[80vh] overflow-y-auto"> {/* Alterado para bg-white/80 */}
